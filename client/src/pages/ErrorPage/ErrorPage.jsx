    ...
    <section className="bg-white ">
      <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
          ...
          <h1 className="mt-3 text-2xl font-semibold text-black/80 md:text-3xl">
            Page not found
          </h1>
        ...
        <div className="relative w-full mt-8 lg:w-1/2 lg:mt-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1609743522653-52354461eb27?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bm90JTIwZm91bmR8ZW58MHx8MHx8fDA%3D"
            alt=""
          />
        </div>
      </div>
